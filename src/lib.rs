// src/lib.rs
/*
 * Core library for OtakuDirectory
 */
...
#[derive(Debug)]
pub struct OtakuDirectoryProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OtakuDirectoryProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OtakuDirectory processing");
    
    let mut processor = OtakuDirectoryProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OtakuDirectoryProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OtakuDirectoryProcessor::new(false);
